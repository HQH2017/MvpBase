...
import com.www.he.BuildConfig;
import com.www.he.R;
import com.www.he.http.net.ApiException;
import com.www.he.utils.BaseSPManager;
import com.www.he.utils.FixMemLeak;
import com.www.he.utils.InstanceUtil;
...
//                StatusBarUtil.setTransparent(this);
     ...
     */
    @Override
    public void showError(Throwable t) { L.msg(t.getMessage());
        if (t instanceof ConnectException) {
            ...
            ToastUtil.s(getString(R.string.base_cparse_failed));
    ...
    protected void onDestroy() {
        ...
        RxBusUtil.get().unregister(this);
        FixMemLeak.fixLeak(getActivity());   // 华为手机6.0 inputMethodManager出现内存泄露
    }
